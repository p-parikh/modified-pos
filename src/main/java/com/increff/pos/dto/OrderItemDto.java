...
public class OrderItemDto {
    ...
    public void update(Integer id, List<OrderItemForm> orderItemFormList) throws ApiException{
        ...
        for(OrderItemForm orderItemForm : orderItemFormList) {
            ...
            orderItemApi.update(id, OrderItemDtoHelper.convertToOrderItemPojo(orderItemForm, productPojo.getId(), id));
        }
    }

    @Transactional(rollbackFor = ApiException.class)
    public void create(List<OrderItemForm> orderItemFormList) throws ApiException {
