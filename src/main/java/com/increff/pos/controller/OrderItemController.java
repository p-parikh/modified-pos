...
public class OrderItemController {
    ...
    public void create(@RequestBody List<OrderItemForm> orderItemFormList) throws ApiException{
        orderItemDto.create(orderItemFormList);
    }

    @ApiOperation(value = "Update order")
    @RequestMapping(path= "/edit/{id}", method = RequestMethod.PUT)
    public void update(@PathVariable Integer id, @RequestBody List<OrderItemForm> orderItemFormList) throws ApiException{
        orderItemDto.update(id, orderItemFormList);
    }

    @ApiOperation(value = "Get orderItem by order id")
    @RequestMapping(path = "/view/order/{id}", method = RequestMethod.GET)
